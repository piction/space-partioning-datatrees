...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var kdTree_1 = __webpack_require__(1);
	var collapsibleTree_1 = __webpack_require__(4);
	var canvas, ctx;
	var points = [];
	...
	var tree = new kdTree_1.KdTree(distance, ["x", "y"]);
	var testCollapse = new collapsibleTree_1.CollapsibleTree();
	function getCount() {
	    var total = 0;
	    function count(node) {
	        if (node == null)
	...
	window.document.addEventListener("DOMContentLoaded", function (event) {
	    ...
	    document.getElementById("rebuild").addEventListener("click", function () {
	        tree = new kdTree_1.KdTree(distance, ["x", "y"]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var binaryHeap_1 = __webpack_require__(3);
	var KdTree = (function () {
...
/***/ function(module, exports) {
	...
	var BinaryHeap = (function () {
	    ...
	    BinaryHeap.prototype.push = function (element) {
	        this.content.push(element); // add add the end of the array
	        this.bubbleUp(this.content.length - 1); // start letting it bubble up
	    };
	    ...
	    BinaryHeap.prototype.peek = function () { return this.content[0]; };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MARGIN = { top: 20, right: 120, bottom: 20, left: 120 }, width = 960 - MARGIN.right - MARGIN.left, height = 600 - MARGIN.top - MARGIN.bottom;
	...
	var CollapsibleTree = (function () {
	    ...
	    CollapsibleTree.prototype.render = function (data) {
	        ...
	        var h_root = d3.stratify()
	            ...
	            .parentId(function (d) { return d.parent; })(flat);
	        tree(h_root);
